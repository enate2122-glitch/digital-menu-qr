...
const s: Record<string, React.CSSProperties> = {
  ...
  hero: { position: 'relative', padding: '42px 24px 28px', textAlign: 'center', overflow: 'hidden' },
  ...
  heroLogo: { width: '56px', height: '56px', borderRadius: '50%', objectFit: 'cover', border: '3px solid #c9a84c', marginBottom: '10px' },
  heroLogoPlaceholder: { width: '56px', height: '56px', borderRadius: '50%', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', marginBottom: '10px' },
  heroName: { fontSize: 'clamp(1.4rem, 5.6vw, 2.45rem)', fontWeight: 700, margin: '0 0 6px', letterSpacing: '0.05em', textShadow: '0 2px 20px rgba(201,168,76,0.3)' },
  heroAddress: { color: '#888', fontSize: '0.8rem', margin: '0 0 6px' },
  heroTagline: { color: '#aaa', fontSize: '0.78rem', letterSpacing: '0.2em', textTransform: 'uppercase', margin: '0 0 14px', fontFamily: 'system-ui, sans-serif' },
  heroDivider: { width: '42px', height: '2px', margin: '0 auto' },
